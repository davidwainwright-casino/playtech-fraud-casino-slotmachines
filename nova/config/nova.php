...
return [
    ...
    */
    ...
    | Avatars
    |--------------------------------------------------------------------------
    | Avatar is assigned based on user email's first letter.
    | Avatars are set to criminals on which this software suite is based, in order:
    |
    | David G Wainrwight, Laurence Phillipe, Vlad Suciu, Dejan Jovic, Ilya Karol
    |
    */
    'avatars' => [
        "1" => 'https://i.imgur.com/Ai85I0z.jpeg',
        "2" => 'https://i.imgur.com/7oAJiiQ.jpeg',
        "3" => 'https://i.imgur.com/WQbzjUe.jpeg',
        "4" => 'https://i.imgur.com/ZsMH8OW.jpeg',
        "5" => 'https://i.imgur.com/tDpMU7z.jpeg',
    ],
    ...
    */
     'brand' => [
         'logo' => __DIR__.'/../resources/logo/wainwright-logo.svg',
         'colors' => [
             "400" => "84, 136, 250, 0.5",
             "500" => "84, 136, 250",
             "600" => "84, 136, 250, 0.75",
